...
IKUKURU_LOGIN_PASSWORD = os.environ.get("IKUKURU_LOGIN_PASSWORD")
MINT_LOGIN_USER = os.environ.get("MINT_LOGIN_USER")
MINT_LOGIN_PASSWORD = os.environ.get("MINT_LOGIN_PASSWORD")
MERUPARA_LOGIN_USER = os.environ.get("MERUPARA_LOGIN_USER")
MERUPARA_LOGIN_PASSWORD = os.environ.get("MERUPARA_LOGIN_PASSWORD")
